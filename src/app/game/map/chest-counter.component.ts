...
export class ChestCounterComponent extends ContainerComponent {
  ...
  constructor(props?:ComponentType<Container>) {
    super(Object.assign(props, {
      children: [
        ...
        }).anchor(0.5).texture('key', 'content'),
        new BitmapTextComponent({
          tag: ['text-value'],
          element: {
            position: new Point(-28, -8),
            text: GameModelData.instance.powerKeys.toString(),
            font: '34px lobster',
            tint: 0xEEEEEE,
    ...
    GameModelData.instance.on('powers-keys', (value:number) => {
